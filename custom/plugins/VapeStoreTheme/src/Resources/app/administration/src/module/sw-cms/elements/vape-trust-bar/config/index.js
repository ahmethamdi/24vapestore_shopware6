import template from './vape-cms-el-config-trust-bar.html.twig';
import './vape-cms-el-config-trust-bar.scss';
    ...
    computed: {
        ...
        iconOptions() {
            return ICON_OPTIONS.map((opt) => ({
                value: opt.value,
                label: this.$t(`vape-cms.elements.trustBar.icons.${opt.value}`),
            }));
        },
    },
